...
#define HAVE_diva_divmodqi4 1
#define HAVE_sw_divmodqi4 1
#define HAVE_diva_udivmodqi4 1
#define HAVE_sw_udivmodqi4 1
#define HAVE_diva_divmodhi4 1
#define HAVE_sw_divmodhi4 1
#define HAVE_diva_udivmodhi4 1
#define HAVE_sw_udivmodhi4 1
#define HAVE_divmodpsi4 1
#define HAVE_udivmodpsi4 1
#define HAVE_diva_divmodsi4 1
#define HAVE_sw_divmodsi4 1
#define HAVE_diva_udivmodsi4 1
#define HAVE_sw_udivmodsi4 1
#define HAVE_diva_divsf3_call (avr_is_valid_for_diva_op())
#define HAVE_sw_divsf3_call (!avr_is_valid_for_diva_op())
...
#define HAVE_diva_ashlsi3 (avr_is_valid_for_diva_op())
#define HAVE_sw_ashlsi3 1
#define HAVE_sw_ashlsq3 1
#define HAVE_sw_ashlusq3 1
#define HAVE_sw_ashlsa3 1
#define HAVE_sw_ashlusa3 1
...
#define HAVE_diva_ashrsi3 (avr_is_valid_for_diva_op())
#define HAVE_sw_ashrsi3 1
#define HAVE_sw_ashrsq3 1
#define HAVE_sw_ashrusq3 1
#define HAVE_sw_ashrsa3 1
#define HAVE_sw_ashrusa3 1
...
#define HAVE_diva_lshrsi3 (avr_is_valid_for_diva_op())
#define HAVE_sw_lshrsi3 1
#define HAVE_sw_lshrsq3 1
#define HAVE_sw_lshrusq3 1
#define HAVE_sw_lshrsa3 1
#define HAVE_sw_lshrusa3 1
...
#define HAVE_sbrx_branchqi 1
#define HAVE_sbrx_branchhi 1
#define HAVE_sbrx_branchpsi 1
#define HAVE_sbrx_branchsi 1
#define HAVE_sbrx_branchdi 1
...
#define HAVE_jump 1
#define HAVE_call_insn ((mchp_check_for_conversion(insn)))
#define HAVE_call_value_insn ((mchp_check_for_conversion(insn)))
#define HAVE_nop 1
#define HAVE_sez 1
#define HAVE_bit_set_sreg 1
#define HAVE_bit_load_sreg 1
#define HAVE_popqi 1
#define HAVE_cli_sei 1
#define HAVE_call_prologue_saves 1
#define HAVE_epilogue_restores 1
#define HAVE_call_isr_prologue_saves (avr_call_isr_prologues)
#define HAVE_isr_epilogue_restores 1
...
#define HAVE_xload_di_libgcc (avr_xload_libgcc_p (DImode))
#define HAVE_xload_dq_libgcc (avr_xload_libgcc_p (DQmode))
#define HAVE_xload_udq_libgcc (avr_xload_libgcc_p (UDQmode))
#define HAVE_xload_da_libgcc (avr_xload_libgcc_p (DAmode))
#define HAVE_xload_uda_libgcc (avr_xload_libgcc_p (UDAmode))
#define HAVE_xload_ta_libgcc (avr_xload_libgcc_p (TAmode))
#define HAVE_xload_uta_libgcc (avr_xload_libgcc_p (UTAmode))
#define HAVE_xloaddi8_A (can_create_pseudo_p() \
   && avr_mem_memx_p (operands[1]) \
   && REG_P (XEXP (operands[1], 0)))
#define HAVE_xloaddq8_A (can_create_pseudo_p() \
   && avr_mem_memx_p (operands[1]) \
   && REG_P (XEXP (operands[1], 0)))
#define HAVE_xloadudq8_A (can_create_pseudo_p() \
   && avr_mem_memx_p (operands[1]) \
   && REG_P (XEXP (operands[1], 0)))
#define HAVE_xloadda8_A (can_create_pseudo_p() \
   && avr_mem_memx_p (operands[1]) \
   && REG_P (XEXP (operands[1], 0)))
#define HAVE_xloaduda8_A (can_create_pseudo_p() \
   && avr_mem_memx_p (operands[1]) \
   && REG_P (XEXP (operands[1], 0)))
#define HAVE_xloadta8_A (can_create_pseudo_p() \
   && avr_mem_memx_p (operands[1]) \
   && REG_P (XEXP (operands[1], 0)))
#define HAVE_xloaduta8_A (can_create_pseudo_p() \
   && avr_mem_memx_p (operands[1]) \
   && REG_P (XEXP (operands[1], 0)))
...
#define HAVE_movdi 1
#define HAVE_movdq 1
#define HAVE_movudq 1
#define HAVE_movda 1
#define HAVE_movuda 1
#define HAVE_movta 1
#define HAVE_movuta 1
...
extern rtx        gen_diva_divmodqi4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sw_divmodqi4                   (rtx, rtx, rtx, rtx);
extern rtx        gen_diva_udivmodqi4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sw_udivmodqi4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_diva_divmodhi4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sw_divmodhi4                   (rtx, rtx, rtx, rtx);
extern rtx        gen_diva_udivmodhi4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sw_udivmodhi4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_divmodpsi4                     (rtx, rtx, rtx, rtx);
extern rtx        gen_udivmodpsi4                    (rtx, rtx, rtx, rtx);
extern rtx        gen_diva_divmodsi4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sw_divmodsi4                   (rtx, rtx, rtx, rtx);
extern rtx        gen_diva_udivmodsi4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sw_udivmodsi4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_diva_divsf3_call               (void);
extern rtx        gen_sw_divsf3_call                 (void);
...
extern rtx        gen_diva_ashlsi3                   (rtx, rtx, rtx);
extern rtx        gen_sw_ashlsi3                     (rtx, rtx, rtx);
extern rtx        gen_sw_ashlsq3                     (rtx, rtx, rtx);
extern rtx        gen_sw_ashlusq3                    (rtx, rtx, rtx);
extern rtx        gen_sw_ashlsa3                     (rtx, rtx, rtx);
extern rtx        gen_sw_ashlusa3                    (rtx, rtx, rtx);
...
extern rtx        gen_diva_ashrsi3                   (rtx, rtx, rtx);
extern rtx        gen_sw_ashrsi3                     (rtx, rtx, rtx);
extern rtx        gen_sw_ashrsq3                     (rtx, rtx, rtx);
extern rtx        gen_sw_ashrusq3                    (rtx, rtx, rtx);
extern rtx        gen_sw_ashrsa3                     (rtx, rtx, rtx);
extern rtx        gen_sw_ashrusa3                    (rtx, rtx, rtx);
...
extern rtx        gen_diva_lshrsi3                   (rtx, rtx, rtx);
extern rtx        gen_sw_lshrsi3                     (rtx, rtx, rtx);
extern rtx        gen_sw_lshrsq3                     (rtx, rtx, rtx);
extern rtx        gen_sw_lshrusq3                    (rtx, rtx, rtx);
extern rtx        gen_sw_lshrsa3                     (rtx, rtx, rtx);
extern rtx        gen_sw_lshrusa3                    (rtx, rtx, rtx);
...
extern rtx        gen_sbrx_branchqi                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sbrx_branchhi                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sbrx_branchpsi                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sbrx_branchsi                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sbrx_branchdi                  (rtx, rtx, rtx, rtx);
...
extern rtx        gen_bit_set_sreg                   (rtx, rtx);
extern rtx        gen_bit_load_sreg                  (rtx, rtx, rtx);
...
extern rtx        gen_call_isr_prologue_saves        (rtx);
extern rtx        gen_isr_epilogue_restores          (rtx);
...
extern rtx        gen_xload_di_libgcc                (void);
extern rtx        gen_xload_dq_libgcc                (void);
extern rtx        gen_xload_udq_libgcc               (void);
extern rtx        gen_xload_da_libgcc                (void);
extern rtx        gen_xload_uda_libgcc               (void);
extern rtx        gen_xload_ta_libgcc                (void);
extern rtx        gen_xload_uta_libgcc               (void);
extern rtx        gen_xloaddi8_A                     (rtx, rtx);
extern rtx        gen_xloaddq8_A                     (rtx, rtx);
extern rtx        gen_xloadudq8_A                    (rtx, rtx);
extern rtx        gen_xloadda8_A                     (rtx, rtx);
extern rtx        gen_xloaduda8_A                    (rtx, rtx);
extern rtx        gen_xloadta8_A                     (rtx, rtx);
extern rtx        gen_xloaduta8_A                    (rtx, rtx);
...
extern rtx        gen_movdq                          (rtx, rtx);
extern rtx        gen_movudq                         (rtx, rtx);
extern rtx        gen_movda                          (rtx, rtx);
extern rtx        gen_movuda                         (rtx, rtx);
extern rtx        gen_movta                          (rtx, rtx);
extern rtx        gen_movuta                         (rtx, rtx);
