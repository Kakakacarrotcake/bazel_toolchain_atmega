/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/jenkins/agent/workspace/XC8_AVR_xc8-avr-tc_xc8/src/gcc/gcc/config/avr/avr.md'.  */
...
extern int status_io_address_operand (rtx, machine_mode);
