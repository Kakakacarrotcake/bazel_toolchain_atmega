...
#define	f1_as_dividend	(*(__uint24 *)&f1)
#define	f2_as_divisor	(*(__uint24 *)&f2)
#define	f3_as_quot	(*(__uint24 *)&f3)
...
#endif
{
	...
	// unpack the operands
	if((exp = (unsigned char)(f1_as_dividend >> 15)) == 0)
		return 0.0;
	if((exp2 = (unsigned char)(f2_as_divisor >> 15)) == 0)
		return 0.0;
	f3_as_quot = 0;
